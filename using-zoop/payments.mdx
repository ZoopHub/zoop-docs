...
Only the account owner can connect Stripe and manage payment settings. Other team roles do not see Settings → Payments.
</Callout>
...
Disconnecting Stripe from within Zoop isn't available right now. The **Disconnect** control is hidden while a safe disconnect-and-reconnect flow is built — disconnecting mid-stream would block charges on in-flight invoices and stop refunds. Either way, your invoices, payments, and customer records always stay in Zoop and are never deleted.
...
<Callout type="info">
<Image src="https://doc-assets.zoop.pro/images/using-zoop/payments/record-payment-dialog.png" alt="The Record payment dialog with amount, method, reference, and date fields" />
</Callout>
