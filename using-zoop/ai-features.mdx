...
A connected assistant works in Zoop's own voice — short, plain, and to the point. After it does something for you, it confirms in a sentence and hands you a "Verify on Zoop" link straight to the record it touched, so you can open it and check the details yourself.
