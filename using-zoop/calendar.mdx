...
<Image src="https://doc-assets.zoop.pro/images/using-zoop/calendar/new-event-modal.png" alt="The new event modal with title, kind, start and end times, assignees, and notes" />
...
<Callout type="warning">Rotating the token breaks the old link immediately. Any app already using it will stop syncing until you paste in the new link.</Callout>
