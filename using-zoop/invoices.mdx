...
<Image src="/images/using-zoop/invoices/invoices-list-status-tabs.png" alt="Invoices list showing status tabs (All, Draft, Sent, In dunning, Overdue, Paid, Uncollectible, Void) and a table of sample invoices with mixed statuses" />
...
<Image src="/images/using-zoop/invoices/invoice-detail-overview.png" alt="Invoice detail page for INV-0001 showing the paid status badge, subtotal, tax, and total summary, line items with tax breakdown, and action buttons at the bottom" />
