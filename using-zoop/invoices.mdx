...
Invoices are how you ask for money. You can create one from scratch, from a completed [job](/using-zoop/jobs), or from an accepted [quote](/using-zoop/quotes). Once sent, your customer gets a payment link they can use to pay by card — or you can record cash, check, or any other offline payment yourself.
  ...
  <Tab title="From scratch">
    <Steps>
      ...
      <Step title="Pick a customer">
        Start typing a name in the customer field and select from the list. You must link a customer before saving. If you started from a customer's detail page, the **Customer** picker is already filled in for you — you can still change it.
      </Step>
