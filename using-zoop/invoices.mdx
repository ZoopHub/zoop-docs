...
<Callout type="info">TODO(screenshot): Invoices list showing status tabs (All, Draft, Sent, In dunning, Overdue, Paid, Uncollectible, Void) and a table of sample invoices with mixed statuses</Callout>
...
<Callout type="info">TODO(screenshot): Invoice detail page for INV-0001 showing the paid status badge, subtotal, tax, and total summary, line items with tax breakdown, and action buttons at the bottom</Callout>
