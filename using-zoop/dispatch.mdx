...
<Callout type="info">In the left sidebar, select **Scheduler** to expand it. You'll see three options: **Calendar**, **Route manager** (your personal My day view), and **Dispatch** (the full team board).</Callout>
