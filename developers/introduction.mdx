...
Replace `zoop_uk_<secret>` with your actual API key, and replace `https://app.zoop.pro` with your Zoop app host (resolve the real host from `GET /.well-known/oauth-protected-resource`).
