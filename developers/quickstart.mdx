...
**Base URL:** examples use the placeholder base URL `https://app.zoop.pro`. For your actual environment (production, staging, or local), fetch `GET /.well-known/oauth-protected-resource` — the `resource` field is the canonical base URL for whatever environment you're hitting.
