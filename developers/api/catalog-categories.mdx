...
<Callout type="info">
Tool names appear here in their canonical dotted form (for example `catalog_categories.create`). When you call a tool, replace the dots with underscores — `catalog_categories_create`. See [tool names](/developers/concepts#tool-names). The example payloads below already use the wire form.
</Callout>
...
```json
{
  ...
  "method": "tools/call",
  "params": {
    "name": "catalog_categories_create",
    "arguments": {
      "name": "HVAC",
...
```json
{
  ...
  "method": "tools/call",
  "params": {
    "name": "catalog_categories_update",
    "arguments": {
      "id": "a1b2c3d4-0002-0000-0000-000000000000",
...
```json
{
  ...
  "method": "tools/call",
  "params": {
    "name": "catalog_categories_delete",
    "arguments": {
      "id": "a1b2c3d4-0002-0000-0000-000000000000"
    }
  }
